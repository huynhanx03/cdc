...
const file_openapi_v3_openapi_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_openapi_v3_openapi_proto_rawDescData []byte
)

func file_openapi_v3_openapi_proto_rawDescGZIP() []byte {
	file_openapi_v3_openapi_proto_rawDescOnce.Do(func() {
		file_openapi_v3_openapi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_openapi_v3_openapi_proto_rawDesc), len(file_openapi_v3_openapi_proto_rawDesc)))
	})
	return file_openapi_v3_openapi_proto_rawDescData
}

var file_openapi_v3_openapi_proto_msgTypes = make([]protoimpl.MessageInfo, 78)
var file_openapi_v3_openapi_proto_goTypes = []any{
...
func file_openapi_v3_openapi_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_openapi_v3_openapi_proto_rawDesc), len(file_openapi_v3_openapi_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   78,
			NumExtensions: 0,
			NumServices:   0,
