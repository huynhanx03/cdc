...
const file_openapi_v3_annotations_proto_rawDesc = "" +
	"\n" +
...
var file_openapi_v3_annotations_proto_goTypes = []any{
...
func file_openapi_v3_annotations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_openapi_v3_annotations_proto_rawDesc), len(file_openapi_v3_annotations_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 4,
			NumServices:   0,
